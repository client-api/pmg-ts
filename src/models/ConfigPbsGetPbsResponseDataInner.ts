 ...
 * 
 * @export
 * @interface ConfigPbsGetPbsResponseDataInner
 */
export interface ConfigPbsGetPbsResponseDataInner {

    /**
     * Proxmox Backup Server datastore name.
     * @type {string}
     * @memberof ConfigPbsGetPbsResponseDataInner
     */
    datastore: string;
...
/**
 * Check if a given object implements the ConfigPbsGetPbsResponseDataInner interface.
 */
export function instanceOfConfigPbsGetPbsResponseDataInner(value: object): value is ConfigPbsGetPbsResponseDataInner {
...
export function ConfigPbsGetPbsResponseDataInnerFromJSON(json: any): ConfigPbsGetPbsResponseDataInner {
    return ConfigPbsGetPbsResponseDataInnerFromJSONTyped(json, false);
}

export function ConfigPbsGetPbsResponseDataInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConfigPbsGetPbsResponseDataInner {
    if (json == null) {
        return json;
    }
    return {
...
export function ConfigPbsGetPbsResponseDataInnerToJSON(json: any): ConfigPbsGetPbsResponseDataInner {
    return ConfigPbsGetPbsResponseDataInnerToJSONTyped(json, false);
}

export function ConfigPbsGetPbsResponseDataInnerToJSONTyped(value?: ConfigPbsGetPbsResponseDataInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
